...
if ($Netshare_path == "/tmp/myshare"){
	$file = "http://".$_SERVER["SERVER_NAME"].'/'. "media3" . substr($_GET["dir"],12) .'/'.stripslashes($_GET["file"]);
}else{
...
<!--OBJECT ID="GomX1" WIDTH=600 HEIGHT=400 CLASSID="CLSID:632CC9D6-5602-4854-AFD2-6EFC59177DE5" CODEBASE="http://app.gomlab.com/eng/gom/GOMPLAYERENSETUP.EXE"-->
