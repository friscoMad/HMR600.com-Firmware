...
$STR_Video_title = "Movies, TV shows & Clips";   //new
$STR_Audio_title = "Music & Audio CD's";		//new
$STR_Photo_title = "Pictures & Images";			//new
$STR_All_title = "All";							//new
$STR_Logout = "Log Out";
$STR_Setup = "Setup";
$STR_Home = "Home";
$STR_Video = "Video";
...
$STR_PortChangeConfirm = "If you change HTTP Port, Xtreamer will be Restarted..!";
...
$STR_Hostname_Update="Do you want to change Hostname?";
...
$STR_Restore = "Restore";
$STR_RestoreConfirm = "After restore Xtreamer will reboot. Do you really want to restore?";
$STR_RestoreSuccess = "Restored Successfully, system will reboot now...";
$STR_FactoryReset = "Restore Default:";
$STR_Reset = "Reset";
$STR_ResetConfirm = "After reset Xtreamer will reboot. Do you really want to reset?";
...
$STR_Cancel = "Cancel";												//new
$STR_File_recvd = "File Received";									//new
$STR_Pending = "Pending ...";										//new
$STR_Uploading = "Uploading ...";									//new
$STR_Moving = "Moving ...";											//new
$STR_Cancelled= "Cancelled";										//new
$STR_Stopped = "Stopped";											//new
$STR_InvalidName = "Invalid file name.";							//new
$STR_FileAlreadyExists = "File with this name already exists.";		//new
$STR_FileTooBig = "File is too big";								//new
$STR_ZeroByteFiles = "Cannot upload Zero Byte files.";				//new
$STR_InvalidFileType = "Invalid File Type.";						//new
$STR_UnhandledError = "Unhandled Error";							//new
