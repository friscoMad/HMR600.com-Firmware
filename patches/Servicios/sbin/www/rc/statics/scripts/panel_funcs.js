...
function fMovies()
{
	post_to_url('../../../play.php?dir=Video playlist', {'Video':'post'});
}

function fMusic()
{
	post_to_url('../../../play.php?dir=Audio playlist', {'Video':'post'});
}

function fPictures()
{
	post_to_url('../../../play.php?dir=Photo playlist', {'Video':'post'});
}
...
function fScreenShot()
{
    document.location.href = "screenshot.php"; 
	//alert('Will support later');
}

function fShowNowPlaying()
{
    document.location.href = "nowplaying.php"; 
	//alert('Will support later');
}
