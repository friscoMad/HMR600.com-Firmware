...
<body>
    ...
    <map name="subPage">        
        <area shape="rect" coords="112,2,2,63" title="<?echo $STR_Screenshot;?>" href="#" onclick="goTo('fScreenShot')">
		<area shape="rect" coords="317,2,205,65" title="<?echo $STR_Now_Playing;?>" href="#" onclick="goTo('fShowNowPlaying')">
        <area shape="rect" coords="199,3,117,112" title="<?echo $STR_Main;?>" href="#" onclick="goTo('fShowMainControl')">
        <area shape="rect" coords="43,70,0,113" title="Previous" href="#" onclick="goTo('fPrevious')">
        <area shape="rect" coords="49,70,105,112" title="Play/Pause" href="#" onclick="goTo('fPlay')">
        <area shape="rect" coords="210,72,262,112" title="Stop" href="#" onclick="goTo('fStop')">
        <area shape="rect" coords="268,71,319,112" title="Next" href="#" onclick="goTo('fNext')">
