...
<body marginheight="0" marginwidth="0" leftmargin="0" topmargin="0" bgcolor="#012436" oncontextmenu="return false;" onload="document.forms.port.port.focus()">
...
function changeport(){
	...
	if(!document.port.port.value){
		...
		alert('<?echo $STR_PortRange;?>');
	}else if(confirm('<?echo $STR_PortChangeConfirm . '\n \t' . $STR_PortChangeConfirm1;?>')){
	...
	<tr><td>
		<table cellspacing="0" cellpadding="0" border="0"><tr>
			...
			<td><font face="arial" color="white" size="2">
				...
				<font face="arial" color="white" size="2">|&nbsp</td>
			<td><a href="setup_http.php">
				<font face="arial" color="#ff0000" size="2"><b><u><?echo $STR_HTTP_Head;?></u> </b></font>
				<font face="arial" color="white" size="2">|&nbsp</td>
			<td><font face="arial" color="white" size="2">
	...
	<tr><td width=100></td>
		...
		<form name="port" method="post" action='javascript:changeport();'>
				  <table border="0" >
					  ...
					  <tr><td ><font face="Arial" color="white" size="2"><?echo $STR_PortNo;?></td>
						<td width="170"><input type="text" name="port" class="textbox" size="20" maxlength="4" onKeyPress="onlyDigits();" value=<?echo $port;?> ></td>
						<td><input type="button" class='btn_2' name="saveport" id="saveport" value="<?echo $STR_Apply;?>" onClick="javascript:changeport();"></td>
					  </tr>
				  </table>
		</form>
		</td>
