...
$tempfile = "'/tmp/ramfs/volumes/C:/.cached'";
if (!file_exists($tempfile)) {
	shell_exec("mkdir '/tmp/ramfs/volumes/C:/.cached'");
}
...
shell_exec("rm -rf '/tmp/ramfs/volumes/C:/.cached/*'");
...
//alert('<? echo $mediapath;?>');

		var swfu;
		var mediapath = encodeURIComponent('<? echo $mediapath;?>');
		//alert(mediapath);
		window.onload = function() {
			var settings = {
				flash_url : "swfupload.swf",
				upload_url: "upload_file.php?dir="+ mediapath,
...
<body marginwidth=0 marginheight=0 leftmargin=0 topmargin=0 oncontextmenu='return false' ondragstart='return false' onunLoad="window.opener.location.reload();">
