...
<tr><td valign=top>
	...
	<tr>
		<td><input type="button" name="vertical"  value=" " style="background: url('vertical.png');background-color:Transparent; height:35px; width:35px; border:none; cursor:hand" title="<?echo $STR_Vertical;?>" onclick="newwindow(10, 680, 'index.php', 'rc_2');"></td>
	</tr>
	<tr>
	...
	<tr>
		<td><input type="button" name="screenshot"  value=" " style="background: url('screenshot_icon.png');background-color:Transparent; height:35px; width:35px; border:none; cursor:hand" title="<?echo $STR_Screenshot;?>" onclick="newwindow(540, 530, 'screenShot.php', 'rc_2');"></td>
	</tr>
...
<td>
	...
	<table width=154 height=534 cellspacing="0" cellpadding="0" border="1" bordercolor="#808080" bgcolor="black">
	<tr><td>
		<center>
		...
		<tr height=40>
			...
			<!--td align=center><input type="button" class='btn_2' name="FL"  value="FL" onclick="newwindow(500, 270, 'index1.php');"></td>
			<td align=center><a href="index1.php">FL</a></td-->
		</tr>
		</table>
		</center>
