...
function newwindow(w,h,webaddress,name){
	var viewimageWin = window.open(webaddress,name,"toolbar=no,location=no,directories=no,status=no,menubar=no,scrollbars=yes,resizable=yes,copyhistory=no,width="+w+",height="+h);
...
<tr>
	<td colspan=2 width='520px' height='240px'>
	<?
		if($type == "Photo"){
			echo "<div id='screenshot'>";
			echo "<a href='$playing_file'><img src='$playing_file' width='515' height='240px' title='$playing' border='0' /></a>";
			echo "</div>";
		}else{
	?>
		<div id="screenshot">
			<a href='../screenshot.bmp'><img src='../screenshot.bmp' width='520px' height='240px' title='ScreenShot' border='0' /></a>
		</div>
	<?}?>
...
<td valign=top>
	...
	<tr>
		<td><input type="button" name="vertical"  value=" " style="background: url('vertical.png');background-color:Transparent; height:35px; width:35px; border:none; cursor:hand" title="<?echo $STR_Vertical;?>" onclick="newwindow(250, 680, 'index.php', 'rc_2');"></td>
	</tr>
	<tr>
		<td><input type="button" name="horizontal"  value=" " style="background: url('horizontal.png');background-color:Transparent; height:35px; width:35px; border:none; cursor:hand" title="<?echo $STR_Horizontal;?>" onclick="newwindow(550, 270, 'index1.php', 'rc_2');"></td>
	</tr>

	<form name="playlist" method='post'>
		<tr>
			<td><input type="button" class='btn_2' value=" " style="background: url('movies_btn.png');background-color:Transparent; height:35px; width:35px; border:none; cursor:hand" title="<?echo $STR_Play_Video_list;?>" onclick="javascript:Playit('Video playlist');"></td>
		</tr>

		<tr>
			<td><input type="button" class='btn_2' value=" " style="background: url('music_btn.png');background-color:Transparent; height:35px; width:35px; border:none; cursor:hand" title="<?echo $STR_Play_Audeo_list;?>" onclick="javascript:Playit('Audio playlist');"></td>
		</tr>

		<tr>
			<td><input type="button" class='btn_2' value=" " style="background: url('pictures_btn.png');background-color:Transparent; height:35px; width:35px; border:none; cursor:hand" title="<?echo $STR_Play_Photo_list;?>" onclick="javascript:Playit('Photo playlist');"></td>
		</tr>
		<tr>
			<td><input type="button" class='btn_2' value=" " style="background: url('refresh_icon.png');background-color:Transparent; height:35px; width:35px; border:none; cursor:hand" title="<?echo $STR_Refresh;?>" onclick="javascript:window.location.reload();"></td>
		</tr>
	</form>
	</table>
</td>
...
<td valign=top>
	...
	<table width=480 cellspacing="0" cellpadding="0" border="1" bordercolor="#808080" bgcolor="black">
	<tr><td>
		<center>
