<?php
//This file will allow to create Play List (mylist.Picture).
session_start();
error_reporting(0);
...
return false;
	...
	document.playlist.action="./m3uPhotoList.php?dir=<? echo $mediapath;?>";
...
return false;
	...
	document.mylist.action="./m3uPhotoListremove.php?dir=<? echo $mediapath;?>";
...
function Playit(){
	document.mylist.target = 'gframe';
	document.mylist.action = 'play.php?dir=Photo playlist';
	document.mylist.submit();
}
</script>
...
<body marginwidth=0 marginheight=0 leftmargin=0 topmargin=0 oncontextmenu="return false;">
	<table width="987" height="94" background="dlf/top_menu.jpg" border="0" cellspacing="0" cellpadding="0">
		<tr>
			<td width=30%><img src="dlf/icon_photo.jpg" height="94" width="189"/></td>
          	<td width=40% align="center"><font face="arial" color="#ff0000"><h2><?echo $STR_MyListPhotoTitle;?></h2></font></td>
...
?>
	...
	echo "<input type='checkbox' name='selectall' onclick='checkAllmylist(playlist);'><font color='white' face='Arial' size='2'>" . $STR_SelectAll;
					...
					$filename = "/usr/local/etc/mylist.Picture";
