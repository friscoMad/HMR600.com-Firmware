<?php
//This file will allow to create Play List (mylist.Music).
session_start();
error_reporting(0);
...
return false;
	...
	document.playlist.action="./m3uMusicList.php?dir=<? echo $mediapath;?>";
...
return false;
	...
	document.mylist.action="./m3uMusicListremove.php?dir=<? echo $mediapath;?>";
...
function Playit(){
	document.mylist.target = 'gframe';
	document.mylist.action = 'play.php?dir=Audio playlist';
	document.mylist.submit();
}
</script>
...
<body marginwidth=0 marginheight=0 leftmargin=0 topmargin=0 oncontextmenu="return false;">
	<table width="987" height="94" background="dlf/top_menu.jpg" border="0" cellspacing="0" cellpadding="0">
		<tr>
			<td width=30%><img src="dlf/icon_music.jpg" height="94" width="189" /></td>
          	<td width=40% align="center"><font face="arial" color="#ff0000"><h2><?echo $STR_MyListMusicTitle;?></h2></font></td>
...
?>
		...
		<td align=middle>
		      ...
		      <input type="button" name="add" class="btn_2" value=" => " onclick='javascript:addlist();';>
			  </form>
			  <?
			  echo "<form id='mylist' name='mylist' method='post' enctype='multipart/form-data'>";
			  ?>
				<?echo $STR_Remove;?></font>

		      <input type="button" name="remove" class='btn_2' value=" <= " onclick='javascript:removelist();';>
