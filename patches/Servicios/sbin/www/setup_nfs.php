...
<tr><td width=350>&nbsp</td>
	...
	<tr><td>
		<table cellspacing="0" cellpadding="0" border="0"><tr>
			...
			<td><a href="setup_nfs.php">
				<font face="arial" color="#ff0000" size="2"><b><u><?echo $STR_NFS_Client;?></u></b>
				<font face="arial" color="white" size="2">|&nbsp</td>
			<td><font face="arial" color="white" size="2">
	...
	<tr><td width=0></td>
		...
		<form name="nfs" action="javascript:local_nfs_change()" method="post">
			<table border="0">
			  <!--tr><td></td>
			  <td><input type="text" name="l_mount" class="textbox" size="50" style="display: none;" value="<?echo $_SESSION['NFS'];?>"><br></td></tr>
			  ...
			  <tr height=5></tr>
			  <tr><td width="130"><font face="Arial" color="white" size="2"><?echo $STR_Local_Mount;?> (Network Shares)</td>
			  ...
			  <tr><td width="130"><font face="Arial" color="white" size="2"><?echo $STR_Options;?> &nbsp&nbsp&nbsp&nbsp&nbsp -o</td>
