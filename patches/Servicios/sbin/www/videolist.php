	...
	if ($mydir != "/tmp/myshare"){
		...
		if((substr($mydir, -4) == ".smb") || (substr($mydir, -4) == ".nfs") and ($output1[0] == "")){
			...
			if ($result != 0){
				...
				echo "<script>location.href='videolist.php?dir=$uplink';</script>";
			}else if($id != ''){
				echo "<script>location.href='videolist.php?dir=$mydir';</script>";
			}
		}
				...
				<tr>
					...
					<td valign="bottom">
						...
						<tr>
							...
							<td height="30" width="40" valign="bottom" align="middle">
							...
							<td height="30" width="30" valign="bottom">
								<?
								 //Mylist
								 if (($Netshare_path != "/tmp/myshare")){
									echo"<input type='button' class='btn_1' onMouseOver='this.style.color= \"#ff0000\"' onMouseOut='this.style.color=\"#FFFFFF\"' name='add' value='".$STR_Mylist."'	onclick=\"newwindow(987, 675, 'm3uVideo.php', 'videolist');\";>";
								 }
...
<PARAM NAME=FlashVars VALUE="txtToCopy=Raju.Lia.com&js=alertUser()">
<param name="movie" value="copyButton.swf">
<embed src="copyButton.swf" flashvars="txtToCopy=Raju.Lia.com&js=alertUser()" width="60" height="20">
</embed>
</object>
</div-->
	...
	//	echo "<div>";
		...
		if (substr($line1[$x],0,1) != 'd'){
			 if ((strtolower(strrchr($files[$x],'.')) == ".wmv")||(strtolower(strrchr($files[$x],'.')) == ".mpg")|| (strtolower(strrchr($files[$x],'.')) == ".avi") ||(strtolower(strrchr($files[$x],'.')) == ".dat")||(strtolower(strrchr($files[$x],'.')) == ".mpeg")||(strtolower(strrchr($files[$x],'.')) == ".divx")||(strtolower(strrchr($files[$x],'.')) == ".xvid")||(strtolower(strrchr($files[$x],'.')) == ".mkv")||(strtolower(strrchr($files[$x],'.')) == ".mov")||(strtolower(strrchr($files[$x],'.')) == ".asf")||(strtolower(strrchr($files[$x],'.')) == ".ts")||(strtolower(strrchr($files[$x],'.')) == ".ogm")||(strtolower(strrchr($files[$x],'.')) == ".mp4") ||(strtolower(strrchr($files[$x],'.')) == ".vob")||(strtolower(strrchr($files[$x],'.')) == ".flv") ||(strtolower(strrchr($files[$x],'.')) == ".m4v"))
			 {
				...
				echo "<td>";
				echo "<table  width='22' height='2' cellspacing='0' cellpadding='0' border='0'> <tr>";
				...
				echo "<td>";
				echo "<table  width='20' height='2' align='left' cellspacing='0' cellpadding='0' border='0'> <tr>";
				echo "<td><a onClick=\"newwindow(707, 545, 'vlc.php?dir=$mediapath&file=$files[$x]', 'vlc');\"; href='#'><img src='dlf/vlc.png' width='15' height='17' title='VLC Player'></td>";
				echo "</tr></table>";
				echo "</td>";
				...
				{
					echo "<td><a onClick=\"newwindow(600, 600, 'winplay.php?dir=$mediapath&file=$files[$x]', 'WMP');\"; href='#'><img src='dlf/winmedia.png' width='16' height='17' title='Windows Media Player'></td>";
				}
				echo "</tr></table>";
				echo "</td>";
